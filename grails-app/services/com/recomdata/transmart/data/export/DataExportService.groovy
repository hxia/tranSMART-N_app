        ...
        try {
            subsets.each { subset ->
                ...
                if (null != selectedFilesList && !selectedFilesList.isEmpty()) {
                    ...
                    // use to pick up right method to call (NZR or conventional)
                    String analysisName = jobDataMap.get("analysis").toString().toUpperCase()
                        ...
                        selectedFilesList.each() { selectedFile ->
                            ...
                            switch (selectedFile) {
                                ...
                                case "MRNA_DETAILED.TXT":
                                    ...
                                    if (analysisName.equals("PCANz".toUpperCase())) {
                                        retVal = geneExpressionDataService.getNzData(studyList, studyDir, "mRNA.trans", jobDataMap.get("jobName"), resultInstanceIdMap[subset], pivotData, gplIds, pathway, timepoint, sampleType, tissueType, true, subset)
                                    } else if (analysisName.equals("BoxPlotNz".toUpperCase()) || analysisName.equals("SurvivalAnalysisNz".toUpperCase()) || analysisName.equals("TableWithFisherNz".toUpperCase())) {
                                        retVal = geneExpressionDataService.getNzData(studyList, studyDir, "mRNA.trans", jobDataMap.get("jobName"), resultInstanceIdMap[subset], pivotData, gplIds, pathway, timepoint, sampleType, tissueType, true, "")
                                    } else {
                                ...
                                case "SNP.TXT":
                                    ...
                                    if (analysisName.equals("BoxPlotNz".toUpperCase()) ||
                                            analysisName.equals("SurvivalAnalysisNz".toUpperCase()) ||
                                            analysisName.equals("TableWithFisherNz".toUpperCase()) ||
                                            analysisName.equals("PCANz".toUpperCase())
                                    ) {
                                        gotData = snpDataService.getNzSnpDataByResultInstanceAndGene(resultInstanceIdMap[subset], study, pathway, sampleType, timepoint, tissueType, jobDataMap.get("jobName"))
                                    } else {
                                        gotData = snpDataService.getSnpDataByResultInstanceAndGene(resultInstanceIdMap[subset], study, pathway, sampleType, timepoint, tissueType, snpData, fileLocation, true, true)
                                    }
                                    if (jobDataMap.get("analysis") != "DataExport") {
