...
class NetezzaSnpDataService {
    ...
    def getNzSnpDataByResultInstanceAndGene(resultInstanceId, study, pathway, sampleType, timepoint, tissueType, jobName) {
        //This boolean tells us whether we retrieved data or not.
        Boolean retrievedData = false;

        //These will be the two parts of the SQL statement. This SQL gets our SNP data by probe.
        // We'll need to extract the actual genotypes/copynumber later.
        StringBuilder sSelect = new StringBuilder()
        sSelect = createSnpSelect(pathway, sampleType, timepoint, tissueType)

        // added to create SNP data table for nzr  by HX  01/10/2014
    ...
    StringBuilder createSnpSelect(pathway, sampleType, timepoint, tissueType) {

        //Get the pathway to use the unique id.
