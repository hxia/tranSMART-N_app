...
class NetezzaClinicalDataService {
    ...
    // dynamic create query for clinical data
    public StringBuilder createClinicalQuery(String[] conceptCodeList, List retrievalTypes, boolean parFilterHighLevelConcepts,
                                             Map filesDoneMap, List platformsList, String[] parentConceptCodeList, Boolean includeConceptContext) {
    ...
    public boolean getData(List studyList, File studyDir, String fileName, String jobName, String resultInstanceId,
        ...
        if (null != resultInstanceId) {
            //Construct the SQL Query.
            sqlQuery = createClinicalQuery(conceptCodeList, retrievalTypes, parFilterHighLevelConcepts, filesDoneMap, platformsList, parentConceptCodeList, includeConceptContext)
        }
